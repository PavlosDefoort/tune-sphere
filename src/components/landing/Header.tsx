      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        >
          <svg
            ...
            viewBox="0 0 496 512"
            className="w-12 h-12 text-white p-2 bg-spotifyGreen hover:bg-spotifyHover rounded-full"
          >
          ...
          <span className="ml-3 text-2xl dark:text-white dark:hover:text-slate-300 ">
            TuneSphere
          </span>
        </Link>
